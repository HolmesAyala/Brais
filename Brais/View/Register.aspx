...
&nbsp;&nbsp;&nbsp;&nbsp;
                    <asp:RadioButtonList ID="RadioButtonList1" runat="server" Font-Bold="True" Width="125px">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <tr>
                <td class="auto-style2" colspan="2">
                    <asp:Button ID="Button1" runat="server" BackColor="#66FFFF" Font-Bold="True" Font-Names="Arial" Font-Size="20px" ForeColor="#0066FF" Text="Registrarse" />
                </td>
            </tr>
        </table>
